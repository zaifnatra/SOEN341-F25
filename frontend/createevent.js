// createevent.js
  // Fetch and display all events from MongoDB
    async function loadEvents() {
      ...
      try {
        ...
        events.forEach((ev) => {
          ...
          // Optional: display first QR code thumbnail
          if (ev.qrCodes && ev.qrCodes.length > 0) {
            ...
            // ensure QR and button stack vertically
            qrImg.style.display = "block";
            qrImg.style.margin = "10px auto 5px";

          }

          // Add a "Sign Up" button for each event
          const signUpBtn = document.createElement("button");
          signUpBtn.textContent = "Sign Up";
          signUpBtn.classList.add("signup-btn");
          signUpBtn.style.display = "block";
          signUpBtn.style.margin = "0 auto"; // center it under the QR
